...
# This file is the finished "Space Aliens" game
...
def game_scene():
    ...
    for alien_number in range(constants.TOTAL_NUMBER_OF_ALIENS):
        a_single_alien = stage.Sprite(image_bank_1, 8, constants.OFF_SCREEN_X, constants.OFF_SCREEN_X)
    ...
    ship = stage.Sprite(image_bank_1, 4, int(constants.SCREEN_X / 2), constants.SCREEN_Y - constants.SPRITE_SIZE)
